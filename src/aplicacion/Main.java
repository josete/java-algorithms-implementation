...
public class Main{
	...
	public static void main(String args[]){
		...
		Graph.Vertex<Integer> start=grafo.v2;
		...
		System.out.println("Camino grafo no dirigido --> 2 a 8");
		System.out.println(camino);
		
		//Grafo dirigido
		DirectedGraph grafo2 = new DirectedGraph();
		Graph.Vertex<Integer> start2=grafo2.v2;
		Graph.Vertex<Integer> end2=grafo2.v8;
		AStar star2=new AStar<Integer>();
		List<Graph.Edge<Integer>>camino2=star2.aStar(grafo2.graph, start2, end2);
		System.out.println("Camino grafo dirigido --> 2 a 8");
